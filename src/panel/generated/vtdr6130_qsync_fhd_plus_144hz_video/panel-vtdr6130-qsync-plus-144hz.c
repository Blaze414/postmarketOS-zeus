...
struct vtdr6130_qsync_plus_144hz {
...
static inline
struct vtdr6130_qsync_plus_144hz *to_vtdr6130_qsync_plus_144hz(struct drm_panel *panel)
{
	return container_of_const(panel, struct vtdr6130_qsync_plus_144hz, panel);
}

static void vtdr6130_qsync_plus_144hz_reset(struct vtdr6130_qsync_plus_144hz *ctx)
{
...
static int vtdr6130_qsync_plus_144hz_on(struct vtdr6130_qsync_plus_144hz *ctx)
{
...
static int vtdr6130_qsync_plus_144hz_off(struct vtdr6130_qsync_plus_144hz *ctx)
{
	struct mipi_dsi_multi_context dsi_ctx = { .dsi = ctx->dsi };
...
static int vtdr6130_qsync_plus_144hz_prepare(struct drm_panel *panel)
{
	struct vtdr6130_qsync_plus_144hz *ctx = to_vtdr6130_qsync_plus_144hz(panel);
	struct device *dev = &ctx->dsi->dev;
	struct drm_dsc_picture_parameter_set pps;
	int ret;

	vtdr6130_qsync_plus_144hz_reset(ctx);

	ret = vtdr6130_qsync_plus_144hz_on(ctx);
	if (ret < 0) {
...
static int vtdr6130_qsync_plus_144hz_unprepare(struct drm_panel *panel)
{
	struct vtdr6130_qsync_plus_144hz *ctx = to_vtdr6130_qsync_plus_144hz(panel);
	struct device *dev = &ctx->dsi->dev;
	int ret;

	ret = vtdr6130_qsync_plus_144hz_off(ctx);
	if (ret < 0)
...
static int vtdr6130_qsync_plus_144hz_get_modes(struct drm_panel *panel,
					       struct drm_connector *connector)
{
	return drm_connector_helper_get_modes_fixed(connector, &vtdr6130_qsync_plus_144hz_mode);
}

static const struct drm_panel_funcs vtdr6130_qsync_plus_144hz_panel_funcs = {
	.prepare = vtdr6130_qsync_plus_144hz_prepare,
	.unprepare = vtdr6130_qsync_plus_144hz_unprepare,
	.get_modes = vtdr6130_qsync_plus_144hz_get_modes,
};

static int vtdr6130_qsync_plus_144hz_probe(struct mipi_dsi_device *dsi)
{
	struct device *dev = &dsi->dev;
	struct vtdr6130_qsync_plus_144hz *ctx;
	int ret;

	ctx = devm_drm_panel_alloc(dev, struct vtdr6130_qsync_plus_144hz, panel,
				   &vtdr6130_qsync_plus_144hz_panel_funcs,
...
static void vtdr6130_qsync_plus_144hz_remove(struct mipi_dsi_device *dsi)
{
	struct vtdr6130_qsync_plus_144hz *ctx = mipi_dsi_get_drvdata(dsi);
	int ret;
...
static const struct of_device_id vtdr6130_qsync_plus_144hz_of_match[] = {
	{ .compatible = "mdss,vtdr6130-qsync-plus-144hz" }, // FIXME
	{ /* sentinel */ }
};
MODULE_DEVICE_TABLE(of, vtdr6130_qsync_plus_144hz_of_match);

static struct mipi_dsi_driver vtdr6130_qsync_plus_144hz_driver = {
	.probe = vtdr6130_qsync_plus_144hz_probe,
	.remove = vtdr6130_qsync_plus_144hz_remove,
	.driver = {
		.name = "panel-vtdr6130-qsync-plus-144hz",
		.of_match_table = vtdr6130_qsync_plus_144hz_of_match,
	},
};
module_mipi_dsi_driver(vtdr6130_qsync_plus_144hz_driver);

MODULE_AUTHOR("linux-mdss-dsi-panel-driver-generator <fix@me>"); // FIXME
MODULE_DESCRIPTION("DRM driver for vtdr6130 amoled qsync video mode dsi visionox panel with DSC");
MODULE_LICENSE("GPL");
